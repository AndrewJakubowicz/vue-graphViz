  ...
  var a = function () {
      var a = '<div class="colpick"><div class="colpick_color"><div class="colpick_color_overlay1"><div class="colpick_color_overlay2"><div class="colpick_selector_outer"><div class="colpick_selector_inner"></div></div></div></div></div><div class="colpick_hue"><div class="colpick_hue_arrs"><div class="colpick_hue_larr"></div><div class="colpick_hue_rarr"></div></div></div><div class="colpick_new_color"></div><div class="colpick_current_color"></div><div class="colpick_hex_field"><div class="colpick_field_letter">#</div><input type="text" maxlength="6" size="6" /></div><div class="colpick_rgb_r colpick_field"><div class="colpick_field_letter">R</div><input type="text" maxlength="3" size="3" /><div class="colpick_field_arrs"><div class="colpick_field_uarr"></div><div class="colpick_field_darr"></div></div></div><div class="colpick_rgb_g colpick_field"><div class="colpick_field_letter">G</div><input type="text" maxlength="3" size="3" /><div class="colpick_field_arrs"><div class="colpick_field_uarr"></div><div class="colpick_field_darr"></div></div></div><div class="colpick_rgb_b colpick_field"><div class="colpick_field_letter">B</div><input type="text" maxlength="3" size="3" /><div class="colpick_field_arrs"><div class="colpick_field_uarr"></div><div class="colpick_field_darr"></div></div></div><div class="colpick_hsb_h colpick_field"><div class="colpick_field_letter">H</div><input type="text" maxlength="3" size="3" /><div class="colpick_field_arrs"><div class="colpick_field_uarr"></div><div class="colpick_field_darr"></div></div></div><div class="colpick_hsb_s colpick_field"><div class="colpick_field_letter">S</div><input type="text" maxlength="3" size="3" /><div class="colpick_field_arrs"><div class="colpick_field_uarr"></div><div class="colpick_field_darr"></div></div></div><div class="colpick_hsb_b colpick_field"><div class="colpick_field_letter">B</div><input type="text" maxlength="3" size="3" /><div class="colpick_field_arrs"><div class="colpick_field_uarr"></div><div class="colpick_field_darr"></div></div></div><div class="colpick_submit"></div></div>',
        e = {
          ...
          var a, e = t(this).parent().parent();
          this.parentNode.className.indexOf("_hex") > 0 ? (e.data("colpick").color = a = i(L(this.value)), l(a, e.get(0)), r(a, e.get(0))) : this.parentNode.className.indexOf("_hsb") > 0 ? (e.data("colpick").color = a = X({
          ...
          }), l(a, e.get(0)), n(a, e.get(0))) : (e.data("colpick").color = a = o(E({
          ...
          })), n(a, e.get(0)), r(a, e.get(0))), s(a, e.get(0)), p(a, e.get(0)), f(a, e.get(0)), e.data("colpick").onChange.apply(e.parent(), [a, d(a), c(a), e.data("colpick").el, 0])
        }, v = function () {
          ...
          return h.apply(a.data.field.get(0), [!0]), a.data.el.removeClass("colpick_slider").find("input").focus(), t(document).off("mouseup", m), t(document).off("mousemove", _), !1
        }, b = function (a) {
          a.preventDefault ? a.preventDefault() : a.returnValue = !1;
          var e = {
            cal: t(this).parent(),
          ...
          return h.apply(e.cal.data("colpick").fields.eq(4).val(parseInt(360 * (e.cal.data("colpick").height - (i - e.y)) / e.cal.data("colpick").height, 10)).get(0), [e.cal.data("colpick").livePreview]), !1
        }, x = function (t) {
          var a = "touchmove" == t.type ? t.originalEvent.changedTouches[0].pageY : t.pageY;
          return h.apply(t.data.cal.data("colpick").fields.eq(4).val(parseInt(360 * (t.data.cal.data("colpick").height - Math.max(0, Math.min(t.data.cal.data("colpick").height, a - t.data.y))) / t.data.cal.data("colpick").height, 10)).get(0), [t.data.preview]), !1
        }, y = function (a) {
          ...
          a.data("colpick").origColor = e, u(e, a.get(0)), a.data("colpick").onSubmit(e, d(e), c(e), a.data("colpick").el)
        }, T = function (a) {
          a.stopPropagation();
          ...
          a.data("colpick").color = e, l(e, a.get(0)), n(e, a.get(0)), r(e, a.get(0)), s(e, a.get(0)), p(e, a.get(0)), f(e, a.get(0))
        };
      return {
        init: function (c) {
          ...
          return this.each(function () {
            if (!t(this).data("colpickId")) {
              ...
              o.find("div.colpick_hue").on("mousedown touchstart", b), e.newColor = o.find("div.colpick_new_color"), e.currentColor = o.find("div.colpick_current_color"), o.data("colpick", e), l(e.color, o.get(0)), r(e.color, o.get(0)), n(e.color, o.get(0)), p(e.color, o.get(0)), s(e.color, o.get(0)), u(e.color, o.get(0)), f(e.color, o.get(0)), e.flat ? (o.appendTo(this).show(), o.css({
                position: "relative",
                display: "block"
        ...
        setColor: function (a, e) {
          ...
          return this.each(function () {
            if (t(this).data("colpickId")) {
              ...
              i.data("colpick").color = a, i.data("colpick").origColor = a, l(a, i.get(0)), r(a, i.get(0)), n(a, i.get(0)), p(a, i.get(0)), s(a, i.get(0)), f(a, i.get(0)), i.data("colpick").onChange.apply(i.parent(), [a, d(a), c(a), i.data("colpick").el, 1]), e && u(a, i.get(0))
            }
          })
        }
      }
    ...
    e = function (t) {
      ...
      var a = {
        ...
        o = i - e;
      return a.b = i, a.s = 0 != i ? 255 * o / i : 0, a.h = 0 != a.s ? t.r == i ? (t.g - t.b) / o : t.g == i ? 2 + (t.b - t.r) / o : 4 + (t.r - t.g) / o : -1, a.h *= 60, a.h < 0 && (a.h += 360), a.s *= 100 / 255, a.b *= 100 / 255, a
    }, c = function (t) {
      var a = {}, e = t.h,
        i = 255 * t.s / 100,
        o = 255 * t.b / 100;
